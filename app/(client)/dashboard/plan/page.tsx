...
export default async function ClientPlanPage() {
  ...
  return (
    <div className="workspace-grid">
      <PageIntro
        eyebrow="Weekly plan"
        title="Your lessons laid out clearly for the week."
        description="A simple timeline of what is coming up, paired with the handful of facts that matter most."
        aside={
          <>
      ...
      >
        ...
        <span className="pill neutral">Calendar aware</span>
      </PageIntro>
