...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-coral focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        warning: "border-transparent bg-warning-light text-warning-700",
